...
const DEMANDS = [
  {
    ...
    title: "Fair wages",
    description:
      "According to PSAC, The Treasury Board’s wage offer — averaging 2.06% per year from 2021–25 — is completely out of touch with the soaring cost of living across Canada and asks workers to take a big pay cut when they need a raise most.",
  ...
  },
  {
    ...
    description:
    "Canadians rightfully expect that their government will not terminate workers without just cause. The government should reappoint officials who were wrongfully dismissed.",
